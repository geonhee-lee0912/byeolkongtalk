...
export const QUESTIONS: Question[] = [
  { id: "q1", axis: "yinYang", prompt: "마을 잔칫날. 마당은 시끌벅적, 조용한 방엔 서너 명.", options: [
    { id: "q1a", text: "마당 한복판에서 신나게 놀기", weights: { 양: 2 } },
    { id: "q1b", text: "아는 얼굴마다 인사", weights: { 양: 2, 생: 1 } },
    { id: "q1c", text: "조용한 방에서 서넛과 밤새 이야기꽃", weights: { 음: 2 } },
    { id: "q1d", text: "슬쩍 빠져나와 달구경", weights: { 음: 2, 인: 1 } },
  ] },
  { id: "q2", axis: "yinYang", prompt: "오랜만에 열린 장터, 바글바글.", options: [
  ...
  { id: "q3", axis: "yinYang", prompt: "며칠 밤낮 힘든 일 치른 후 회복법은?", options: [
  ...
  { id: "q7", axis: "wealth", prompt: "이웃의 동업 제안, 어딘가 사기꾼 냄새.", options: [
    { id: "q7a", text: "본전·수익부터 따짐", weights: { 재: 2 } },
    { id: "q7b", text: "작게 발 담가보고 되면 키움", weights: { 재: 2, 유: 1 } },
    { id: "q7c", text: "돈보다 재미가 먼저", weights: { 인: 2 } },
    { id: "q7d", text: "그 사람 성격·진심을 먼저 겪어봄", weights: { 인: 2, 생: 1 } },
  ] },
  { id: "q8", axis: "wealth", prompt: "하늘이 주는 것 하나 고르기.", options: [
    { id: "q8a", text: "마르지 않는 쌀 창고", weights: { 재: 2 } },
    { id: "q8b", text: "만지면 값 오르는 손", weights: { 재: 2, 강: 1 } },
    { id: "q8c", text: "세상 모든 책이 든 서재", weights: { 인: 2 } },
    { id: "q8d", text: "사람 속마음이 들리는 귀", weights: { 인: 2, 음: 1 } },
  ] },
  { id: "q9", axis: "wealth", prompt: "장에 두 자리가 났다.", options: [
    { id: "q9a", text: "잘 팔리는 국밥 가게, 남는 게 실리", weights: { 재: 2 } },
    { id: "q9b", text: "목 좋은 자리부터 잡아 키운다", weights: { 재: 2, 강: 1 } },
    { id: "q9c", text: "벌이는 적어도 아이들 글 가르치는 일이 뜻있다", weights: { 인: 2 } },
    { id: "q9d", text: "가게 하며 틈틈이 아이들도 가르친다", weights: { 인: 2, 유: 1 } },
  ] },
  { id: "q10", axis: "nurture", prompt: "친구가 흥정 손해로 울상.", options: [
