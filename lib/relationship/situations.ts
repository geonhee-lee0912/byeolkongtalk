...
export const SITUATIONS: SimSituation[] = [
  {
    ...
    contextPrompt: "무슨 계기로 고백하려는 마음이 든 거야? 둘이 지금 어떤 사이인지 알려줘.",
    safety: "normal",
  },
  {
    id: "crush-firsttext",
    ...
    contextPrompt: "얼마 만에 연락하는 거야? 마지막으로 얘기했을 때 분위기는 어땠어?",
    safety: "normal",
  },
  {
    id: "dating-hurt",
    ...
    contextPrompt: "뭐에 서운했어? 언제부터 쌓인 거야?",
    safety: "normal",
  },
  {
    id: "dating-makeup",
    ...
    contextPrompt: "무슨 일로 싸웠어? 지금 서로 어떤 상태야?",
    safety: "normal",
  },
  {
    ...
    contextPrompt: "그 사람이랑 지금 어떤 접점이 있어? (같은 반·직장·취미 등)",
    safety: "high",
  },
  {
    id: "onesided-decide",
    ...
    contextPrompt: "고백을 망설이는 가장 큰 이유가 뭐야?",
    safety: "high",
  },
  {
    ...
    contextPrompt: "언제·왜 헤어졌고, 지금 왜 다시 연락하고 싶어?",
    safety: "high",
  },
  {
    id: "breakup-closure",
    ...
    contextPrompt: "그때 못 하고 마음에 남은 말이 뭐야?",
    safety: "high",
  },
];
