...
const SECTION_GUIDE: Record<FortuneType, string> = {
  ...
  saju_report_card: [
    ...
    `  "scores": [`,
    `    { "domain": "재물운", "grade": "<학점(예: A+, B0, C, F 등). 사주 근거로 정직하게, 매번 좋은 학점만 금지>", "comment": "<재물운 한 줄 코멘트. 2~3문장.>" },`,
    `    { "domain": "애정운", "grade": "<학점>", "comment": "<2~3문장.>" },`,
    `    { "domain": "직업운", "grade": "<학점>", "comment": "<2~3문장.>" },`,
    `    { "domain": "건강운", "grade": "<학점>", "comment": "<2~3문장.>" },`,
    `    { "domain": "인간관계운", "grade": "<학점>", "comment": "<2~3문장.>" }`,
    `  ],`,
    `  "totalGrade": "<종합 학점>",`,
    `  "totalComment": "<재치있는 담임 총평. 4~5문장.>",`,
