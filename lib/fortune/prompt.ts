...
const SECTION_GUIDE: Record<FortuneType, string> = {
  ...
  saju_full: [
    ...
    `  "summary": "<2026 병오년이 이 사주에 주는 핵심 메시지. 큰 그림을 그려주는 따뜻한 요약. 4~5문장.>",`,
    `  "lucky": {`,
    `    "color": "<행운 색 이름, 예: 라벤더>",`,
    ...
    `  },`,
    `  "self": {`,
    `    "nature": "<일간·오행 기반 타고난 기질·성격. 5~6문장.>",`,
    `    "strength": "<강점·빛나는 재능. 5~6문장.>",`,
    `    "caution": "<조심할 성향·보완점. 따뜻한 자기이해 톤. 5~6문장.>",`,
    `    "balance": {`,
    `      "lack": "<오행 밸런스 진단. 어떤 기운이 강하고 부족한지, 보완하면 어떤 점이 좋은지. 4~5문장.>",`,
    `      "supplements": ["<보완 키워드 2~4개. 예: 붉은 계열>", "<예: 남쪽>", "<예: 햇빛 산책>"]`,
    `    },`,
    `    "aptitude": "<타고난 적성·어울리는 일. 기질 기반 커리어 방향. 5~6문장.>"`,
    `  },`,
    `  "year": {`,
    `    "flow": "<2026년 큰 흐름·테마. 병오년 기운이 이 사주에 주는 한 해 전반. 가장 긴 도입 서술. 6~7문장.>",`,
    `    "mind": "<2026년 마음·감정 흐름. 5~6문장.>",`,
    `    "love": "<2026년 사랑·인연. 5~6문장.>",`,
    `    "relationship": "<2026년 인간관계·사회. 5~6문장.>",`,
    `    "career": "<2026년 일·커리어. 5~6문장.>",`,
    `    "wealth": "<2026년 재물·금전. 5~6문장.>",`,
    `    "health": "<2026년 건강·컨디션. 5~6문장.>"`,
    `  },`,
    `  "relations2026": "<2026 인연 지도: 올해 이 사람에게 힘이 되는 사람의 결(어떤 기운·성향과 잘 통하는지)과, 거리를 두거나 살펴보면 좋은 관계 패턴. 병오년 기운과 이 사람 오행을 근거로 구체적으로. 6~7문장.>",`,
    `  "mission": "<올해의 성장 과제: 이 사람이 2026년에 타고난 강점을 어떻게 펼치면 좋을지, 한 해 마음에 두면 좋은 성장 포인트. 따뜻한 자기이해 톤으로. 6~7문장.>",`,
    `  "monthly": [`,
    `    { "month": 1,  "body": "<1월 흐름·조언. 3~4문장.>" },`,
    `    { "month": 2,  "body": "<2월. 3~4문장.>" },`,
    `    { "month": 3,  "body": "<3월. 3~4문장.>" },`,
    `    { "month": 4,  "body": "<4월. 3~4문장.>" },`,
    `    { "month": 5,  "body": "<5월. 3~4문장.>" },`,
    `    { "month": 6,  "body": "<6월. 3~4문장.>" },`,
    `    { "month": 7,  "body": "<7월. 3~4문장.>" },`,
    `    { "month": 8,  "body": "<8월. 3~4문장.>" },`,
    `    { "month": 9,  "body": "<9월. 3~4문장.>" },`,
    `    { "month": 10, "body": "<10월. 3~4문장.>" },`,
    `    { "month": 11, "body": "<11월. 3~4문장.>" },`,
    `    { "month": 12, "body": "<12월. 3~4문장.>" }`,
    `  ],`,
    `  "timing": { "good": "<2026년 흐름이 좋은 달, 예: '4 · 9 · 11월'>", "caution": "<점검하면 좋은 달, 예: '6 · 7월'>" },`,
    `  "actions": ["<올해 이것만은 — 실천 1>", "<실천 2>", "<실천 3>"],`,
    `  "note": "<별콩이의 한마디. 2026 한 해 챙기면 좋을 따뜻한 응원 3~4문장.>"`,
    `}`,
    ``,
    `[규칙] 모든 문장은 반말 친구 말투. 단정("~할 거야") 금지, 흐름·가능성("~한 흐름이 보여","~해보면 좋아")으로. 좋기만 한 예언 금지 — 챙길 점도 자연스럽게. relations2026·mission 도 빠뜨리지 말고 반드시 포함해라. monthly 는 1~12월 전부, actions 는 정확히 3개. JSON 문자열 안에서 큰따옴표는 escape(\\")하고 줄바꿈은 넣지 마.`,
  ].join("\n"),
  good_days: [
    `오늘 날짜: ${"{{TODAY}}"}`,
    ``,
  ...
  compat: [
    ...
    `  "note": "<별콩이의 한마디. 두 사람에게 건네는 따뜻한 응원 4~5문장.>"`,
    `}`,
    ``,
