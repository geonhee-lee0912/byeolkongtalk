...
const SECTION_GUIDE: Record<FortuneType, string> = {
  ...
  compat: [
    ...
    `  "chemistry": "<오행 케미: 첫 번째 사람 일간과 두 번째 사람 일간(및 두 사주 오행)이 상생인지 상극인지, 그게 관계에 어떻게 작용하는지 쉽게 풀이. 9~11문장.>",`,
    `  "attraction": "<끌림·성격 케미: 서로 왜 끌리고 어떤 점이 잘 맞는지. 7~8문장.>",`,
  ...
  compat_social: [
    ...
    `  "chemistry": "<오행 케미: 첫 번째 사람 일간과 두 번째 사람 일간(및 두 사주 오행)이 상생인지 상극인지, 그게 관계에 어떻게 작용하는지 쉽게 풀이. 8~9문장.>",`,
    `  "attraction": "<성향 케미: 두 사람 성격·태도가 어떻게 맞물리고 어떤 점에서 잘 통하는지. 6~7문장.>",`,
