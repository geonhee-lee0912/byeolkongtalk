...
const SECTION_GUIDE: Record<FortuneType, string> = {
  ...
  saju_report_card: [
    ...
    ``,
    `{`,
    `  "intro": "<성적표를 여는 담임 코멘트. 재치있게. 4~5문장.>",`,
    `  "scores": [`,
    `    { "domain": "재물운", "grade": "<학점(예: A+, B0, C, F 등). 사주 근거로 정직하게, 매번 좋은 학점만 금지>", "comment": "<재물운 코멘트. 4~5문장.>" },`,
    `    { "domain": "애정운", "grade": "<학점>", "comment": "<4~5문장.>" },`,
    `    { "domain": "직업운", "grade": "<학점>", "comment": "<4~5문장.>" },`,
    `    { "domain": "건강운", "grade": "<학점>", "comment": "<4~5문장.>" },`,
    `    { "domain": "인간관계운", "grade": "<학점>", "comment": "<4~5문장.>" }`,
    `  ],`,
    `  "totalGrade": "<종합 학점>",`,
    `  "totalComment": "<재치있는 담임 총평. 6~7문장.>",`,
