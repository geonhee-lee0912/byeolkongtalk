...
**범위 밖 (별도 계획):** 구독 기간권·블러·3일 체험(②) / 우리 오늘 + 상대 인라인 목록(③) / 계측(④) / 패스·스킬 판매 중단 + `good_days`·`one_card` 폐지 + 낙수 CTA(⑤) / 정적 콘텐츠 생성·검수(⑥) / 일지 캐릭터 에셋(⑦)
...
- 패스·스킬 **판매 중단** — ⑤(탭 재편·폐지) 계획. 이 계획은 진입점만 옮긴다
- `good_days`·`one_card` 폐지 — ⑤ (별마루 배포와 원자적으로)
- 우리 사이 코드·DB 삭제 — 연속기억([[product-backlog]] #13) 도입 시

## 다음 계획

② 구독 기간권 + 블러 게이트 + 3일 체험 → ③ 우리 오늘(상대 인라인 목록 포함) → ④ 계측 → ⑤ 판매 중단 + `good_days`/`one_card` 폐지 + 낙수 CTA → ⑥ 정적 콘텐츠 1회 생성·검수 → ⑦ 일지 캐릭터 에셋
