...
```bash
git add lib/home/banners.ts lib/home/banners.test.ts components/home/PromoCarousel.tsx app/page.tsx
...
```bash
git add components/home/CrossLinkSlots.tsx app/page.tsx
