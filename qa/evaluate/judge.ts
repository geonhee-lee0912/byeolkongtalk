...
const RUBRIC = [
  ...
  "7. 마무리 적절성 — (a) 사용자 직전 발화가 새 질문/미해결 고민인데 무시하고 [END]로 닫지 않았는가 (b) 작별이 갑작스럽거나 사용자를 내치는 톤이 아닌가 (c) 더 묻고 싶은 신호를 차단하지 않았는가 (예외: 사용자가 별콩이가 안내한 다른 상담/이어가기를 수락한 직후(\"그거 볼래\", \"예약할게\" 류)의 따뜻한 한두 문장 + [END]는 위반이 아니다 — 설계된 전환이다.)",
];
