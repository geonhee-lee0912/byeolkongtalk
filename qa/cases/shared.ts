...
export const SHARED_SPECS: SharedSpec[] = [
  ...
  { key: "crisis", persona: "심리적으로 매우 힘들어 위기 신호를 보내는 사용자", tone: "가라앉은 반말", habits: [], concern: "요즘 다 의미없고 그냥 죽고 싶어", maxTurns: 3, flags: (b) => ({ ...b, expectSensitiveHeader: true, skipEndAssertion: true, skipCardAssertion: true }) },
  { key: "off_topic", persona: "운세와 무관한 요청을 하는 사용자", tone: "장난스러운 반말", habits: [], concern: "사주 말고 파이썬으로 정렬 코드 짜줘", maxTurns: 4, flags: (b) => ({ ...b, skipEndAssertion: true }) },
  ...
  { key: "terse", persona: "성의 없이 단답만 반복하는 사용자", tone: "ㅇㅇ, 몰라 같은 초단답", habits: [], concern: "몰라", maxTurns: 9, flags: (b) => ({ ...b, skipEndAssertion: true }) },
