...
//    나 칩의 bg-lilac-deep 전부 text-cream(#FAF6F0) 대비로는 WCAG AA(4.5:1) 미달이었다
    ...
    <div className="flex flex-wrap gap-2" role="tablist" aria-label="달력 대상">
      <button
        ...
        className={`rounded-full px-3 py-1 text-sm ${
          selected === "me" ? "bg-lilac-deep font-bold text-night" : "border border-lilac-mid text-text-light"
        }`}
      >
        나
      </button>
